...
@section('title', 'Manage Flash Sale Product')
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Flash Sale Product</h6>
        </div>
        <div class="card-body">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-danger mt-auto"
                                            href="{{ route('admin.flash.down', $item['id']) }}">Remove</a></div>
                                </div>
                            </div>
                    ...
                    <tbody>
                        @foreach ($product as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item['flag_flash'] == 'no')
                                        <a class="btn btn-success me-2 w-100"
                                            href="{{ route('admin.flash.up', $item['id']) }}">UP
                                        </a>
                                    @else
                                        <a class="btn btn-danger me-2 w-100"
                                            href="{{ route('admin.flash.down', $item['id']) }}">Remove
                                        </a>
                                    @endif
                                </td>
